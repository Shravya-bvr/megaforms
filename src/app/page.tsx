...
function LiveChatDemo() {
  ...
  const questions = [
    ...
    "Great {name}! What's your company email?",
    ...
    <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden w-full max-w-sm">
        ...
        {questions.slice(0, step + 1).map((q, i) => (
          <div key={i} className="space-y-2">
            <div className="flex gap-2 items-end">
              ...
              <div className="bg-gray-50 rounded-2xl rounded-bl-none px-4 py-3 text-sm text-gray-700 max-w-xs leading-relaxed">
                {q.replace('{name}', answers[0] || 'there')}
              </div>
            </div>
            {answers[i] && (
              <div className="flex justify-end">
                <div className="bg-red-600 text-white rounded-2xl rounded-br-none px-4 py-2.5 text-sm font-medium">
                  {answers[i]}
                </div>
              </div>
            )}
        ...
        <div className="px-5 pb-4">
          <div className="flex gap-2 border border-gray-200 rounded-xl overflow-hidden focus-within:border-red-400 transition-colors">
            <input
              ...
              className="flex-1 px-4 py-3 text-sm outline-none bg-white text-gray-700"
              autoFocus
            />
      ...
      {step >= questions.length - 1 && (
        <div className="px-5 pb-5 text-center">
          <button
            onClick={() => { setStep(0); setAnswers([]); setShowInput(false); setIsTyping(false) }}
  ...
  return (
    <main className="bg-white overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 bg-red-50 border border-red-100 text-red-600 px-4 py-2 rounded-full text-xs font-semibold tracking-wide">
              ...
              <h1 className="text-6xl lg:text-7xl font-black text-gray-950 leading-[0.95] tracking-tight">
                Get <span className="text-red-600">3x more</span><br/>
                leads from<br/>your site.
              </h1>
      ...
      <section className="bg-gray-950 py-12 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-white text-xl font-medium leading-relaxed">
            &ldquo;We switched from Google Forms and saw a <span className="text-red-400 font-bold">40% jump in leads</span> within the first week. The conversational format makes all the difference.&rdquo;
          </p>
      ...
      <section className="py-28 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-red-600 text-xs font-bold uppercase tracking-widest mb-3">The difference</p>
            <h2 className="text-5xl font-black text-gray-950">Static forms are <span className="line-through text-gray-300">fine</span> killing your business</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="rounded-2xl border-2 border-gray-100 p-8 relative">
              <div className="absolute top-4 left-4 bg-gray-100 text-gray-500 text-xs font-bold px-3 py-1 rounded-full">OLD METHOD</div>
              <div className="mt-8 space-y-4 opacity-60">
                ...
                <div className="h-10 bg-gray-300 rounded-lg flex items-center justify-center text-gray-500 text-sm">Submit</div>
              </div>
              <p className="mt-6 text-center text-gray-400 text-sm">😴 Boring. Cold. Low completion rate.</p>
            </div>
            <div className="rounded-2xl border-2 border-red-200 bg-red-50/30 p-8 relative">
              <div className="absolute top-4 left-4 bg-red-600 text-white text-xs font-bold px-3 py-1 rounded-full">MEGAFORMS ✨</div>
              <div className="mt-8 space-y-3">
                <div className="flex gap-2 items-end">
                  <div className="w-7 h-7 rounded-full bg-red-600 flex items-center justify-center text-white text-xs font-bold shrink-0">M</div>
                  <div className="bg-white rounded-2xl rounded-bl-none px-4 py-3 text-sm text-gray-700 shadow-sm border border-gray-100">👋 Hi! What&apos;s your name?</div>
                </div>
                <div className="flex justify-end">
                  <div className="bg-red-600 text-white rounded-2xl rounded-br-none px-4 py-2.5 text-sm">Arjun Mehta</div>
                </div>
                <div className="flex gap-2 items-end">
                  <div className="w-7 h-7 rounded-full bg-red-600 flex items-center justify-center text-white text-xs font-bold shrink-0">M</div>
                  <div className="bg-white rounded-2xl rounded-bl-none px-4 py-3 text-sm text-gray-700 shadow-sm border border-gray-100">Love it Arjun! What&apos;s your email? 🚀</div>
                </div>
              ...
              <p className="mt-6 text-center text-gray-600 text-sm font-medium">🔥 Friendly. Human. 3x more completions.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-28 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              {icon:'🕐',title:'Always On',desc:'Captures leads 24×7, even when your team is offline or asleep.'},
              {icon:'📈',title:'3× Conversions',desc:'Visitors respond to chat. Our customers see 3x higher completion rates.'},
              {icon:'✨',title:'Delights Visitors',desc:'A personalised, human experience — automated and 100% consistent.'},
              {icon:'💰',title:'Cuts Costs',desc:'One form replaces hours of manual follow-up and cold outreach.'},
            ].map((card,i) => (
              <div key={i} className="group bg-white p-7 rounded-2xl border border-gray-100 hover:border-red-200 hover:shadow-xl transition-all duration-300 cursor-default hover:-translate-y-1">
                <div className="text-4xl mb-5 group-hover:scale-110 transition-transform duration-300">{card.icon}</div>
      ...
      <section className="py-28 px-6 bg-gray-950 relative overflow-hidden">
        <div className="absolute inset-0 opacity-5" style={{backgroundImage:'radial-gradient(circle, #ef4444 1px, transparent 1px)',backgroundSize:'40px 40px'}}/>
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              {target:3,suffix:'×',label:'Avg conversion lift'},
      ...
      <section className="py-28 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {num:'01',icon:'🤖',title:'Build with AI',desc:'Describe your goal in plain English. AI builds your entire form instantly. Refine with drag-and-drop.'},
              {num:'02',icon:'📋',title:'One-line install',desc:'Paste a single code snippet on your site. Or share a link. Works on any platform in seconds.'},
              {num:'03',icon:'🔔',title:'Watch leads arrive',desc:'Get notified instantly via email, Slack, or your CRM. Every response, in real time.'},
            ].map((step,i) => (
              <div key={i} className="group relative bg-white border border-gray-100 hover:border-red-200 rounded-2xl p-8 hover:shadow-xl transition-all duration-300">
                <p className="text-8xl font-black text-gray-50 group-hover:text-red-50 leading-none mb-4 transition-colors">{step.num}</p>
      ...
      <section className="py-28 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <p className="text-red-600 text-xs font-bold uppercase tracking-widest mb-3">Deployment</p>
          <h2 className="text-5xl font-black text-gray-950 mb-4">3 ways to deploy</h2>
          <p className="text-gray-400 mb-16">Widget on your site, a shareable link, or embedded inline — your choice.</p>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {num:'1',icon:'💬',title:'Chat Widget',desc:'A floating bubble on your site corner. Proactively starts conversations without disrupting your UX.'},
              {num:'2',icon:'🔗',title:'Shareable Link',desc:'A standalone full-page form with its own URL. Perfect for email campaigns, social, and QR codes.'},
              {num:'3',icon:'📄',title:'Inline Embed',desc:'Drop the form anywhere inside your page — landing pages, blogs, or checkout flows.'},
            ].map((item,i) => (
              <div key={i} className="group bg-white border border-gray-100 hover:border-red-200 rounded-2xl p-10 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div className="w-8 h-8 rounded-full bg-red-50 text-red-600 text-xs font-black flex items-center justify-center mx-auto mb-6 group-hover:bg-red-600 group-hover:text-white transition-all">{item.num}</div>
                <span className="text-5xl mb-6 block">{item.icon}</span>
                <h3 className="font-black text-xl text-gray-900 mb-3 group-hover:text-red-600 transition-colors">{item.title}</h3>
      ...
      <section className="py-28 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              {name:'Aditya Nair',role:'Co-founder, GrowStack',color:'from-red-500 to-orange-500',text:'Demo requests went up 60% in two weeks. The conversational flow feels genuinely human and visitors actually enjoy it.'},
              {name:'Fatima Al-Rashidi',role:'Head of Marketing, NovaBrand',color:'from-red-600 to-red-800',text:'Our recruitment bot brings in 90% of job applications. Setup took under 30 minutes and it has paid for itself 10× over.'},
              {name:'James Whitmore',role:'Product Lead, Cruxly',color:'from-rose-500 to-red-600',text:'Survey completion jumped from 34% to 71% after switching. That\'s nearly double the data with zero extra effort.'},
              {name:'Sneha Kulkarni',role:'Founder, EdifyAI',color:'from-red-400 to-rose-600',text:'Built a student onboarding form in 10 minutes with AI. It looks like we spent weeks on it.'},
              {name:'Carlos Rivera',role:'CTO, Yatratech',color:'from-red-700 to-red-500',text:'Conversions tripled. Customer acquisition cost dropped significantly. MegaForms pays for itself in the first week.'},
              ...
              <div key={i} className="bg-white rounded-2xl p-7 border border-gray-100 hover:shadow-xl transition-all duration-300 flex flex-col gap-5">
      ...
      <section className="py-28 px-6 bg-gray-50">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="border border-gray-100 bg-white rounded-2xl divide-y divide-gray-50 overflow-hidden shadow-sm">
            {[
              {q:'What exactly is MegaForms?',a:'MegaForms replaces cold static forms with friendly one-question-at-a-time conversations. Visitors answer naturally, and you collect cleaner data with dramatically higher completion rates.'},
              {q:'Is there a free plan?',a:'Yes — forever free. 3 forms, 100 responses/month. No credit card. Upgrade only when you need more.'},
              {q:'Do I need to know how to code?',a:'Zero coding needed. Build with AI in seconds, or drag-and-drop manually. Install is one copy-paste.'},
              {q:'Which tools does MegaForms connect with?',a:'Salesforce, HubSpot, Mailchimp, Slack, Google Sheets, Notion, Zapier, webhooks and 100+ more integrations.'},
              {q:'Will it affect my site speed?',a:'No. MegaForms loads asynchronously in the background. Zero impact on Core Web Vitals or PageSpeed scores.'},
            ].map((item,i) => (
      ...
      <section className="py-28 px-6 bg-gray-950 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-64 bg-red-600 rounded-full blur-3xl opacity-10"/>
        </div>
        <div className="max-w-2xl mx-auto text-center relative">
          <p className="text-6xl mb-6">🚀</p>
          <h2 className="text-5xl font-black text-white mb-4 leading-tight">
            Start collecting leads <span className="text-red-500">today</span>
          </h2>
          <p className="text-gray-400 mb-10 leading-relaxed">
            Join 50,000+ businesses using MegaForms to turn visitors into customers — for free.
          </p>
          <div className="flex flex-wrap gap-3 justify-center">
            <Link href="/register" className="bg-red-600 hover:bg-red-700 text-white px-10 py-4 rounded-xl font-bold text-sm transition-all hover:shadow-2xl hover:shadow-red-900/50 hover:-translate-y-0.5">
